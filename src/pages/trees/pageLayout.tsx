  ...
  return (
    ...
    >
      <Helmet>
        ...
        {/* Meta */}
        <meta property="og:title" content={`${data?.artist} - ${data?.title} | JentaJuice`} />
        <meta property="og:image" content={`${data?.cover}`} />
        <meta property="og:description" content={`"${data?.title}" is created by ${data?.artist} and this page is generated by JentaJuice :)`} />
      </Helmet>
